...
# 
# [[ sys.info.like == "debian" ]] && __babashka_load_deps_from_path $ABSOLUTE_PATH/apt && return
# [[ sys.info.like == "arch" ]] && __babashka_load_deps_from_path $ABSOLUTE_PATH/pacman && return
# [[ sys.info.like == "macos" ]]  && __babashka_load_deps_from_path $ABSOLUTE_PATH/homebrew && return
# [[ sys.info.like == "alpine" ]]  && __babashka_load_deps_from_path $ABSOLUTE_PATH/apk && return
# 
# case "`uname -s`" in
#   Linux)
